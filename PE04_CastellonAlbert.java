...
public class PE04_CastellonAlbert {
    ...
    public void tempMenu() {
        ...
        do {
            ...
            switch (menuTemp) {
                case 1:
                    System.out.println("Quans graus vols incrementar la temperatura?");
                    temperature = temperature + changeTemperature();
                    System.out.println("La temperatura s'ha establit a "+ temperature + "ºC");
                    break;
                case 2:
                    System.out.println("Quans graus vols disminuir la temperatura?");
                    temperature = temperature - changeTemperature();
                    System.out.println("La temperatura s'ha establit a "+ temperature + "ºC");
                    break;
                case 3:
                    ...
                    do {
                        ...
                        switch (menuRooms) {
                            case 1:
                                ...
                                if( action== 1 ){
                                    System.out.println("Reproduïnt video...");
                                }else if (action == 2) {
